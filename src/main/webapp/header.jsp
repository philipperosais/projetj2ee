			...
			<div class="container">
				...
				<div class="top-w3pvt d-flex">
					...
					<div class="container forms ml-auto">
						...
						<div class="row justify-content-end">
							<c:if test="${user == null}">
								<a href="${login}" class="btn"><span
									class="fa fa-user-circle-o"></span> Sign In</a>
								<a href="${register}" class="btn"><span
				...
				<div class="nav-top-wthree">
					<nav>
						...
						<ul class="menu">
							...
							<li>
								<!-- First Tier Drop Down --> <label for="drop-2" class="toggle">Dropdown
									<span class="fa fa-angle-down" aria-hidden="true"></span>
							</label> <a href="#">Dropdown <span class="fa fa-angle-down"
									aria-hidden="true"></span></a> <input type="checkbox" id="drop-2" />
								<ul>
									<li><a class="nav-link active" aria-current="page"
										href="${coming}" class="drop-text">Services</a></li>
									<li><a class="nav-link active" aria-current="page"
										href="${about}" class="drop-text">Features</a></li>
									<li><a class="nav-link active" aria-current="page"
										href="${single}" class="drop-text">Single Page</a></li>

								</ul>
							</li>

							<li><a class="nav-link active" aria-current="page"
								href="${shop}">Collections</a></li>
							<li><a class="nav-link active" aria-current="page"
